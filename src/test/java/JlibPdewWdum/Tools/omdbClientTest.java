...
public class omdbClientTest extends TestCase {
    ...
    public void testGetFromTitle() throws Exception {
        ...
        assertEquals("Test harry",r1,omdbClient.getFromTitle("harry"));
    }
    ...
    public void testGetFromTitleYear() throws Exception {
        ...
        assertEquals("Test batman, 1992",r1,omdbClient.getFromTitleYear(1992,"batman"));
    }
}